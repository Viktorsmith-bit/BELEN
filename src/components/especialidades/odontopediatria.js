...
import Tratamientos from '../assets/images/Inicio/Especialidades/odontopediatria.svg';
    ...
    render() {
        return (
            <div className='bg-white'>
                <Nav />
                <div className='odontopediatria marginTop heightImage'>
                    <div className='container-fluid'>
                        <div className="container-xxl py-5 py-md-5 py-lg-4" >
                            <div className='row py-3 py-md-5 py-lg-5'>
                                <div className='col-lg-12 p-3 p-lg-5 d-none d-md-block d-lg-block' >
                                    <h4 className='display-1 fw-bold text-wrap color d-lg-none'>ODONTO</h4>
                                    <h1 className='display-1 fw-bold text-wrap color'><span className='d-none d-lg-inline'>ODONTO</span>PEDIATRÍA</h1>
                                    <p className='lead'>La sonrisa de los niños lo cura todo.</p>
                                    <Link className='btn px-5 py-3 text-white bk-color fw-bold' to='/reservacion'>Reservar cita</Link>
                                </div>
                            </div>
                        </div>
                    </div>

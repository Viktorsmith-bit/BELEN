        ...
        return (
            <div className='aside mt-5 mt-lg-1'>
                ...
                <div className='p-3 p-md-4 p-lg-4 bg-white mt-3 shadow-sm border rounded'>
                    <p className='text-muted'>Debido a nuestras políticas de bioseguridad solo atendemos a dos pacientes por día, si lo que usted presenta es una emergencia, podemos hacer una excepción. Para esto nuestro equipo se pondrá inmediatamente en contacto con usted.</p>
                </div>
                <div className='p-3 p-md-4 p-lg-4 bg-white mt-2 shadow-sm border rounded'>
